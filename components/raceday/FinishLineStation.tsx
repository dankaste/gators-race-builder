        ...
        {results.map((result, i) => {
          ...
          return (
            <div
              ...
              onDrop={(e) => {
                e.preventDefault();
                if (dragPayload) assignToSlot(i, dragPayload);
              }}
            ...
            >
              ...
              {filled ? (
                <div
                  draggable
                  onDragStart={() => setDragPayload({ source: "slot", fromIndex: i, playerId: result.playerId!, bib: result.bib })}
                ...
                >
                  ...
                  <button onClick={() => unassign(i)} title="Unassign this rider" className="text-muted hover:text-danger">
                    ×
                  </button>
                </div>
              ) : (
              ...
              <button onClick={() => removeTiming(i)} title="Remove this timing entirely" className="shrink-0 text-muted hover:text-danger">
                🗑
              </button>
            </div>
          );
